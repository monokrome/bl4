...
-   :material-download:{ .lg .middle } **Download PDF**

    ---

    Get the complete guide as a PDF for offline reading.

    [:material-file-pdf-box: Download PDF](../downloads/bl4-guide.pdf){ .md-button .md-button--primary }
